...
# Remove 'words' that don't add a lot of value to reduce Dimensionality
...
# Classify words into their parts of speech and labeling them accordingly is known as part-of-speech tagging, POS-tagging. Use NLTK to tag text automatically. http://www.nltk.org/book/ch05.html
